...
# Updated Transforms with 140x140 resize to match dataset assertion
...
if os.path.isfile(latest_path):
    ...
    scheduler.last_epoch = start_epoch - 1  # Keep scheduler in sync
...
for epoch in range(start_epoch, epochs):
    ...
    # Save only the best checkpoint and remove previous best
